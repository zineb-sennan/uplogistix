...
@Component({
  ...
  templateUrl: './derniere-position-groupe.component.html',
  styleUrls: ['./derniere-position-groupe.component.css']
})

export class DernierePositionGroupeComponent implements OnInit {
  ...
  changeGroupe(event: any) {
    ...
    this.getPositions(null, groupeId > 0 ? groupeId : null);
  }
