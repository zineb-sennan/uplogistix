        ...
        t = {
                ...
                !(function () {
                    if (n) {
                        const e = JSON.parse(k.showPopover) && "base" === k.sidebarSize,
                            t = new o.J2(n, { offset: [0, 16], placement: "top", customClass: "popover-lg popover-dark d-none d-md-block", trigger: "manual" });
                        e && t.show(),
                    ...
                    (function () {
                        ...
                        for (let t = 0; t < e.length; t++) {
                            const a = e[t].split("="),
                                o = a[0],
                                n = a[1];
                            ("colorScheme" != o && "navPosition" != o && "navColor" != o && "sidebarSize" != o) || (localStorage.setItem("dashkit" + o.charAt(0).toUpperCase() + o.slice(1), n), (k[o] = n));
                        }
                    })(),
                    // "light" == (S = k.colorScheme) ? ((f.disabled = !1), (m.disabled = !0), (S = "light")) : "dark" == S && ((f.disabled = !0), (m.disabled = !1), (S = "dark")),
                    (function (e) {
                        if (l && s && c && i && d && u)
                            if ("topnav" == e) {
                                g(s), g(c), g(i);
                    ...
                    c &&
                        ...
                        l &&
                        ("default" == w
                            ? (c.classList.add("navbar-light"), i.classList.add("navbar-light"), l.classList.add("navbar-light"))
                            : "inverted" == w
                            ? (c.classList.add("navbar-dark"), i.classList.add("navbar-dark"), l.classList.add("navbar-dark"))
                            : "vibrant" == w && (c.classList.add("navbar-dark", "navbar-vibrant"), i.classList.add("navbar-dark", "navbar-vibrant"), l.classList.add("navbar-dark", "navbar-vibrant"))),
                    "base" == (L = k.sidebarSize) ? g(i) : "small" == L && g(c),
                    r &&
                        (function (e, t, a, o, n) {
                            (e.querySelector('[name="colorScheme"][value="' + t + '"]').checked = !0),
                    ...
                    r &&
                        (r.addEventListener("submit", function (e) {
                            e.preventDefault(),
                                (function (e) {
                                    const t = e.querySelector('[name="colorScheme"]:checked').value,
            ...
            328: () => {
                ...
                "undefined" != typeof mapboxgl &&
                    e.forEach((e) => {
                        const t = { ...(e.dataset.map ? JSON.parse(e.dataset.map) : {}), ...{ container: e, style: "mapbox://styles/mapbox/light-v9", scrollZoom: !1, interactive: !1 } };
            ...
            524: (e, t, a) => {
                ...
                l && new r.Sortable(l, { draggable: ".form-check", handle: ".form-check-label", mirror: { constrainDimensions: !0 } });
                var s = a(529),
                    c = a.n(s);
                document.querySelectorAll("[data-choices]").forEach((e) => {
                    const t = {
                        ...
                        ...{
                            classNames: { containerInner: e.className, input: "form-control", inputCloned: "form-control-sm", listDropdown: "dropdown-menu", itemChoice: "dropdown-item", activeState: "show", selectedState: "active" },
                            shouldSort: !1,
                ...
                w && new r.Sortable(w, { draggable: ".kanban-item", mirror: { constrainDimensions: !0 } }),
                    L.forEach((e) => {
                ...
                const q = document.querySelectorAll(".navbar .dropup, .navbar .dropend, .navbar .dropdown, .navbar .dropstart");
                ...
                const J = {
                        gray: { 300: T("--bs-chart-gray-300"), 600: T("--bs-chart-gray-600"), 700: T("--bs-chart-gray-700"), 800: T("--bs-chart-gray-800"), 900: T("--bs-chart-gray-900") },
                        primary: { 100: T("--bs-chart-primary-100"), 300: T("--bs-chart-primary-300"), 700: T("--bs-chart-primary-700") },
                        black: T("--bs-dark"),
                        white: T("--bs-white"),
                ...
                function B(e) {
                    const { chart: t, tooltip: a } = e,
                        o = (function (e) {
                            ...
                            if (!t) {
                                ...
                                o.classList.add("popover-content"), t.appendChild(a), t.appendChild(o), e.canvas.parentNode.appendChild(t);
                            }
                            return t;
                        })(t);
                    ...
                    if (a.body) {
                        ...
                        n.forEach((e, o) => {
                            ...
                            s.classList.add("popover-body-indicator"), (s.style.backgroundColor = "line" === t.config.type && "rgba(0,0,0,0.1)" !== r.borderColor ? r.borderColor : r.backgroundColor);
                            const c = document.createElement("div");
                            c.classList.add("popover-body", "d-flex", "align-items-center", "text-nowrap"), c.classList.add(n.length > 1 ? "justify-content-left" : "justify-content-center");
                    ...
                    (o.style.visibility = "visible"), (o.style.left = n + a.caretX + "px"), (o.style.top = r + a.caretY + "px"), (o.style.transform = "translateX(-50%) translateY(-100%) translateY(-1rem)");
                }
                function M(e) {
                ...
                (I.kL.defaults.responsive = !0),
                    ...
                    (I.kL.overrides.doughnut.plugins.tooltip.callbacks.title = function (e) {
                        return e[0].label;
                    }),
                    ...
                    (I.kL.defaults.scales.linear.grid = { borderDash: [2], borderDashOffset: [2], color: T("--bs-chart-grid-line-color"), drawBorder: !1, drawTicks: !1 }),
                    ...
                    (I.kL.defaults.scales.category.grid = { drawBorder: !1, drawOnChartArea: !1, drawTicks: !1 }),
                ...
                _ &&
                    new I.kL(_, {
                        type: "line",
                        options: { scales: { y: { display: !1 }, x: { display: !1 } }, elements: { line: { borderWidth: 2 }, point: { hoverRadius: 0 } }, plugins: { tooltip: { external: () => !1 } } },
                        data: { labels: new Array(12).fill("Label"), datasets: [{ data: [0, 15, 10, 25, 30, 15, 40, 50, 80, 60, 55, 65] }] },
                    });
                ...
                X &&
                    [].forEach.call(X, function (e) {
                        new I.kL(e, {
                            type: "line",
                            options: { scales: { y: { display: !1 }, x: { display: !1 } }, elements: { line: { borderWidth: 2, borderColor: "#D2DDEC" }, point: { hoverRadius: 0 } }, plugins: { tooltip: { external: () => !1 } } },
                            data: { labels: new Array(12).fill("Label"), datasets: [{ data: [0, 15, 10, 25, 30, 15, 40, 50, 80, 60, 55, 65] }] },
                        });
                    });
        ...
        (o.O = (t, a, n, r) => {
            if (!a) {
                ...
                for (d = 0; d < e.length; d++) {
                    for (var [a, n, r] = e[d], s = !0, c = 0; c < a.length; c++) (!1 & r || l >= r) && Object.keys(o.O).every((e) => o.O[e](a[c])) ? a.splice(c--, 1) : ((s = !1), r < l && (l = r));
                    if (s) {
                        e.splice(d--, 1);
                        var i = n();
                        void 0 !== i && (t = i);
